    ...
    <div className="absolute top-20 right-4 bottom-4 w-full max-w-sm pointer-events-none flex flex-col gap-4 p-4">
      ...
      >
            ...
            <div className="grid grid-cols-3 gap-2">
              {toppers.map((t) => (
                <button
                  ...
                  className={`py-2 text-center text-[10px] border transition-colors ${cakeConfig.topper === t.id ? 'border-primary bg-primary/10 text-primary' : 'border-white/10 hover:bg-white/5'}`}
                >
                  {t.name}
                </button>
              ))}
        ...
        <div className="mt-6 p-3 bg-red-900/10 border border-red-900/20 rounded-lg">
          <p className="text-[10px] text-red-500 font-bold uppercase tracking-widest mb-1">Allergen Warning / অ্যালার্জি সতর্কতা</p>
        ...
        <p className="mt-4 text-[10px] text-neutral-500 text-center uppercase tracking-tighter">
